...
class TrtConvertMultiHeadMatmulTest(TrtLayerAutoScanTest):
    ...
    def sample_program_configs(self):
        ...
        batch_list = [1, 2, 4]
        reshape_shape_list = [[0, 0, 12, 64]]
        dim1_list = [128]
        input2_shape_idx_list = range(2)
        axis_list = [0]
        grid = [
            batch_list,
            reshape_shape_list,
            dim1_list,
            input2_shape_idx_list,
            axis_list,
        ]
        for (
            batch,
            ...
            dics = [
                ...
                {'shape': reshape_shape},
                {'axis': [0, 2, 1, 3]},
                {'scale': 0.125, 'bias': 0.0, 'bias_after_scale': True},
                {
                    'alpha': 1.0,
                    'transpose_X': False,
                    'transpose_Y': True,
            ...
            ops_config = [
                {
                    'op_type': 'mul',
                    'op_inputs': {'X': ['input_data1'], 'Y': ['mul1_weight']},
                ...
                {
                    'op_type': 'reshape2',
                    'op_inputs': {'X': ['elementwise_add1_output']},
                    'op_outputs': {
                ...
                {
                    'op_type': 'mul',
                    'op_inputs': {'X': ['input_data1'], 'Y': ['mul2_weight']},
                ...
                {
                    'op_type': 'reshape2',
                    'op_inputs': {'X': ['elementwise_add2_output']},
                    'op_outputs': {
                ...
                {
                    'op_type': 'mul',
                    'op_inputs': {'X': ['input_data1'], 'Y': ['mul3_weight']},
                ...
                },
                {
                    ...
                    'op_outputs': {'Out': ['elementwise_add3_output']},
                    'op_attrs': dics[9],
                },
                {
                    'op_type': 'reshape2',
                    'op_inputs': {'X': ['elementwise_add3_output']},
                    'op_outputs': {
                ...
                {
                    'op_type': 'scale',
                    'op_inputs': {'X': ['transpose23_output']},
                ...
                },
                {
                    ...
                    'op_outputs': {'Out': ['elementwise_add4_output']},
                    'op_attrs': dics[14],
                },
                {
                    'op_type': 'softmax',
                    'op_inputs': {'X': ['elementwise_add4_output']},
                    'op_outputs': {'Out': ['softmax_output']},
                    'op_attrs': dics[15],
                },
                {
                    'op_type': 'dropout',
                    'op_inputs': {'X': ['softmax_output']},
            ...
            program_config = ProgramConfig(
                ...
                inputs={
                    'input_data1': TensorConfig(
                        data_gen=lambda: generate_input1(batch, dim1)
                    ),
                    'input_data2': TensorConfig(
                        data_gen=lambda: generate_input2(input2_shape)
                    ),
                },
                outputs=['mul4_output'],
            )
...
class TrtConvertVitToMultiHeadMatmulTest(TrtLayerAutoScanTest):
    ...
    def sample_program_configs(self):
        ...
        batch_list = [2, 4]
        length_list = [197]
        grid = [batch_list, length_list]
        for batch, length in itertools.product(*grid):
            self.length = length
            ops_config = [
                {
                    'op_type': 'matmul_v2',
                ...
                {
                    'op_type': 'slice',
                    'op_inputs': {'Input': ['transpose1_output']},
                ...
                },
                {
                    ...
                    'op_outputs': {'Out': ['transpose2_output']},
                    'op_attrs': {
                        'axis': [0, 1, 3, 2],
                        'data_format': 'AnyLayout',
                    },
            ...
            program_config = ProgramConfig(
                ...
                inputs={
                    'input_data1': TensorConfig(
                        data_gen=lambda: generate_input1(batch, length)
                    )
                },
